...
public class CatalogPagesTests : VPureLuxWebTestBase
{
    ...
    [Fact]
    public async Task Product_Code_Manual_Input_Should_Not_Use_Auto_Generator_And_Edit_Allows_Code_Update()
    {
        ...
        productEditPage.ShouldContain("<abp-input asp-for=\"Input.Code\" />");
        productEditPage.ShouldNotContain("<abp-input asp-for=\"Code\" disabled=\"true\" />");
    ...
    [Fact]
    public async Task Catalog_Edit_Code_Binding_Should_Match_Product_And_Component_Rules()
    {
        ...
        })
        {
            ...
            pageSource.ShouldContain("<abp-input asp-for=\"Input.Code\" />");
            pageSource.ShouldNotContain("<abp-input asp-for=\"Code\" disabled=\"true\" />");
        }
        ...
        {
            var inputProperty = modelType.GetProperty("Input");
            inputProperty.ShouldNotBeNull();
            inputProperty!.GetCustomAttributes(typeof(Microsoft.AspNetCore.Mvc.BindPropertyAttribute), inherit: true)
                .ShouldNotBeEmpty();
        }
    }
