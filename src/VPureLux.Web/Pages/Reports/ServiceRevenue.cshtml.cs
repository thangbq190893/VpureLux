...
public class ServiceRevenueModel : VPureLuxPageModel
{
    private static readonly CultureInfo Vi = CultureInfo.GetCultureInfo("vi-VN");
    private readonly IBusinessRevenueAppService _service;
    public BusinessRevenuePageViewModel View { get; private set; } = new() { Mode = "service", TitleKey = "Reports:ServiceRevenue" };
    public ServiceRevenueModel(IBusinessRevenueAppService service) => _service = service;
    ...
    public async Task<JsonResult> OnGetListAsync(GetBusinessRevenueListInput input) => ToJson(await _service.GetServiceListAsync(input));
    public async Task<JsonResult> OnGetSummaryAsync(GetBusinessRevenueListInput input) => new(await _service.GetServiceSummaryAsync(input));
