...
public class ServiceWorkConfiguration : IEntityTypeConfiguration<ServiceWork>
{
    public void Configure(EntityTypeBuilder<ServiceWork> builder)
    {
        ...
        builder.Property(x => x.Unit).HasMaxLength(ServiceConsts.MaxUnitLength);
        builder.Property(x => x.StandardCost).HasPrecision(ServiceConsts.MoneyPrecision, ServiceConsts.MoneyScale);
