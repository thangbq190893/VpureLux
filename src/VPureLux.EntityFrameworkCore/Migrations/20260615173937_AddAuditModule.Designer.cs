...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VPureLux.Pricing.ComponentPurchasePriceVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ComponentId")
                        .IsUnique()
                        .HasDatabaseName("UX_ComponentPurchasePriceVersions_ComponentId_Active")
                        .HasFilter("[Status] = 1 AND [IsDeleted] = 0");

                    b.HasIndex("ComponentId", "VersionNo")
                        .IsUnique()
                        .HasDatabaseName("UX_ComponentPurchasePriceVersions_ComponentId_VersionNo");

                    b.ToTable("AppComponentPurchasePriceVersions", (string)null);
                });
            ...
            modelBuilder.Entity("VPureLux.Pricing.ComponentPurchasePriceVersion", b =>
                {
                    ...
                    b.OwnsOne("VPureLux.Pricing.EffectivePeriod", "EffectivePeriod", b1 =>
                        {
                            b1.Property<Guid>("ComponentPurchasePriceVersionId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("ComponentPurchasePriceVersionId");

                            b1.ToTable("AppComponentPurchasePriceVersions");

                            b1.WithOwner()
                                .HasForeignKey("ComponentPurchasePriceVersionId");
                        });
