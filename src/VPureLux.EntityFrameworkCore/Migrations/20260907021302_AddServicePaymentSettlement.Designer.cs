...
namespace VPureLux.Migrations
{
    ...
    [Migration("20260907021302_AddServicePaymentSettlement")]
    partial class AddServicePaymentSettlement
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VPureLux.Audit.BusinessAuditLog", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.Property<Guid?>("TechnicalAuditLogId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CorrelationId")
                        .HasDatabaseName("IX_BusinessAuditLogs_CorrelationId");

                    b.HasIndex("EntityId")
                        .HasDatabaseName("IX_BusinessAuditLogs_EntityId");

                    b.HasIndex("EntityType")
                        .HasDatabaseName("IX_BusinessAuditLogs_EntityType");

                    b.HasIndex("EventId")
                        .IsUnique()
                        .HasDatabaseName("UX_BusinessAuditLogs_EventId");

                    b.HasIndex("EventTime")
                        .HasDatabaseName("IX_BusinessAuditLogs_EventTime");

                    b.HasIndex("Module")
                        .HasDatabaseName("IX_BusinessAuditLogs_Module");

                    b.HasIndex("Severity")
                        .HasDatabaseName("IX_BusinessAuditLogs_Severity");

                    b.HasIndex("UserId")
                        .HasDatabaseName("IX_BusinessAuditLogs_UserId");

                    b.ToTable("AppBusinessAuditLogs", (string)null);
                });

            modelBuilder.Entity("VPureLux.Bom.BomVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ProductId")
                        .IsUnique()
                        .HasDatabaseName("UX_BomVersions_ProductId_Published")
                        .HasFilter("[Status] = 2 AND [IsDeleted] = 0");

                    b.HasIndex("ProductId", "Status")
                        .HasDatabaseName("IX_BomVersions_ProductId_Status");

                    b.HasIndex("ProductId", "VersionNo")
                        .IsUnique()
                        .HasDatabaseName("IX_BomVersions_ProductId_VersionNo");

                    b.ToTable("AppBomVersions", (string)null);
                });

            modelBuilder.Entity("VPureLux.Catalog.Component", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VPureLux.Catalog.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VPureLux.Customers.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CustomerGroupId", "Status")
                        .HasDatabaseName("IX_Customers_CustomerGroupId_Status");

                    b.ToTable("AppCustomers", (string)null);
                });

            modelBuilder.Entity("VPureLux.Customers.CustomerGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VPureLux.Inventory.InventoryBalance", b =>
                {
                    ...
                    b.HasKey("WarehouseId", "StockItemId");
                    ...
                    b.ToTable("AppInventoryBalances", null, t =>
                        {
                            t.HasCheckConstraint("CK_InventoryBalances_InventoryValue_NonNegative", "[InventoryValue] >= 0");

                            t.HasCheckConstraint("CK_InventoryBalances_QuantityOnHand_NonNegative", "[QuantityOnHand] >= 0");
                        });
                });

            modelBuilder.Entity("VPureLux.Inventory.InventoryLot", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("ReceiptTransactionLineId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("WarehouseId", "StockItemId", "LotNo")
                        .IsUnique()
                        .HasDatabaseName("UX_InventoryLots_WarehouseId_StockItemId_LotNo");

                    b.HasIndex("WarehouseId", "StockItemId", "ReceivedAt", "CreationTime", "Id")
                        .HasDatabaseName("IX_InventoryLots_FIFO");

                    b.ToTable("AppInventoryLots", null, t =>
                        {
                            t.HasCheckConstraint("CK_InventoryLots_AvailableQuantity_NonNegative", "[AvailableQuantity] >= 0");
                        });
                });

            modelBuilder.Entity("VPureLux.Inventory.InventoryLotSupplier", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("InventoryLotId")
                        .IsUnique()
                        .HasDatabaseName("UX_InventoryLotSuppliers_InventoryLotId");

                    b.HasIndex("SupplierId")
                        .HasDatabaseName("IX_InventoryLotSuppliers_SupplierId");

                    b.ToTable("AppInventoryLotSuppliers", (string)null);
                });

            modelBuilder.Entity("VPureLux.Inventory.InventoryTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("WarehouseId", "PostedAt")
                        .HasDatabaseName("IX_InventoryTransactions_WarehouseId_PostedAt");

                    b.ToTable("AppInventoryTransactions", (string)null);
                });

            modelBuilder.Entity("VPureLux.Inventory.StockItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ItemType", "CatalogItemId")
                        .IsUnique()
                        .HasDatabaseName("UX_StockItems_ItemType_CatalogItemId");

                    b.ToTable("AppStockItems", (string)null);
                });

            modelBuilder.Entity("VPureLux.Inventory.Warehouse", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VPureLux.OperatingCosts.OperatingCostCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("Code")
                        .IsUnique()
                        .HasDatabaseName("UX_OperatingCostCategories_Code");

                    b.ToTable("AppOperatingCostCategories", (string)null);
                });

            modelBuilder.Entity("VPureLux.OperatingCosts.OperatingCostEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CategoryId")
                        .HasDatabaseName("IX_OperatingCostEntries_CategoryId");

                    b.HasIndex("EntryDate")
                        .HasDatabaseName("IX_OperatingCostEntries_EntryDate");

                    b.HasIndex("Direction", "PaymentStatus")
                        .HasDatabaseName("IX_OperatingCostEntries_Direction_PaymentStatus");

                    b.ToTable("AppOperatingCostEntries", (string)null);
                });

            modelBuilder.Entity("VPureLux.Pricing.ComponentSuggestedSellingPriceVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ComponentId")
                        .IsUnique()
                        .HasDatabaseName("UX_ComponentSuggestedSellingPriceVersions_ComponentId_Active")
                        .HasFilter("[Status] = 1 AND [IsDeleted] = 0");

                    b.HasIndex("ComponentId", "VersionNo")
                        .IsUnique()
                        .HasDatabaseName("UX_ComponentSuggestedSellingPriceVersions_ComponentId_VersionNo");

                    b.ToTable("AppComponentSuggestedSellingPriceVersions", (string)null);
                });

            modelBuilder.Entity("VPureLux.Pricing.ProductSuggestedPriceVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ProductId")
                        .IsUnique()
                        .HasDatabaseName("UX_ProductSuggestedPriceVersions_ProductId_Active")
                        .HasFilter("[Status] = 1 AND [IsDeleted] = 0");

                    b.HasIndex("ProductId", "VersionNo")
                        .IsUnique()
                        .HasDatabaseName("UX_ProductSuggestedPriceVersions_ProductId_VersionNo");

                    b.ToTable("AppProductSuggestedPriceVersions", (string)null);
                });

            modelBuilder.Entity("VPureLux.Sales.NumberSequence", b =>
                {
                    b.Property<string>("Name")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.ToTable("AppNumberSequences", (string)null);
                });

            modelBuilder.Entity("VPureLux.Sales.SalesOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("CustomerGroupCodeSnapshot")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<Guid?>("CustomerGroupIdSnapshot")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("CustomerGroupNameSnapshot")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.HasIndex("ConfirmationIdempotencyKey")
                        .IsUnique()
                        .HasDatabaseName("UX_SalesOrders_ConfirmationIdempotencyKey")
                        .HasFilter("[ConfirmationIdempotencyKey] IS NOT NULL AND [IsDeleted] = 0");

                    b.HasIndex("CustomerGroupIdSnapshot");

                    b.HasIndex("OrderNo")
                        .IsUnique()
                        .HasDatabaseName("UX_SalesOrders_OrderNo");
            ...
            modelBuilder.Entity("VPureLux.Sales.SalesOrderPayment", b =>
                {
                    ...
                    b.HasIndex("IdempotencyKey")
                        .IsUnique()
                        .HasDatabaseName("UX_SalesOrderPayments_IdempotencyKey")
                        .HasFilter("[IdempotencyKey] IS NOT NULL AND [IsDeleted] = 0");

                    b.HasIndex("SalesOrderId")
                        .HasDatabaseName("IX_SalesOrderPayments_SalesOrderId");
            ...
            modelBuilder.Entity("VPureLux.Service.ServiceOrder", b =>
                {
                    ...
                    b.Property<decimal?>("ActualProfitAmount")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<string>("CompletionCommandHash")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
            ...
            modelBuilder.Entity("VPureLux.Service.ServicePayment", b =>
                {
                    ...
                    b.Property<string>("VoidIdempotencyKey")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
                    ...
                    b.Property<string>("VoidRequestHash")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
            ...
            modelBuilder.Entity("VPureLux.Service.ServiceRefund", b =>
                {
                    ...
                    b.HasIndex("IdempotencyKey")
                        .IsUnique()
                        .HasDatabaseName("UX_ServiceRefunds_IdempotencyKey");

                    b.HasIndex("ServiceOrderId", "RefundDate", "CreationTime", "Id")
                        .HasDatabaseName("IX_ServiceRefunds_Order_History");

                    b.ToTable("AppServiceRefunds", null, t =>
                        {
                            t.HasCheckConstraint("CK_ServiceRefunds_PositiveAmount", "[Amount] > 0");
                        });
                });
            ...
            modelBuilder.Entity("VPureLux.Warranty.AssetMaintenanceEvent", b =>
                {
                    ...
                    b.Property<Guid?>("ServiceOrderLineId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VPureLux.Warranty.AssetReplacementReminder", b =>
                {
                    ...
                    b.Property<int>("CycleMonthsSnapshot")
                        .HasColumnType("int");
                    ...
                    b.Property<Guid?>("NextReminderId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal>("QuantityPerProductSnapshot")
                        .HasPrecision(18, 4)
                        .HasColumnType("decimal(18,4)");
                    ...
                    b.HasIndex("SalesOrderLineId")
                        .HasDatabaseName("IX_AssetReplacementReminders_SalesOrderLineId");
            ...
            modelBuilder.Entity("VPureLux.Warranty.ComponentReplacementPolicy", b =>
                {
                    ...
                    b.ToTable("AppComponentReplacementPolicies", (string)null);
                });

            modelBuilder.Entity("VPureLux.Warranty.CustomerAsset", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VPureLux.Bom.BomVersion", b =>
                {
                    ...
                    b.OwnsMany("VPureLux.Bom.BomItem", "Items", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasIndex("BomVersionId", "LineNo")
                                .HasDatabaseName("IX_BomItems_BomVersionId_LineNo");

                            b1.ToTable("AppBomItems", (string)null);
            ...
            modelBuilder.Entity("VPureLux.Catalog.Component", b =>
                {
                    b.OwnsOne("VPureLux.Catalog.ImageData", "Image", b1 =>
                        {
                            b1.Property<Guid>("ComponentId")
                                .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VPureLux.Customers.Customer", b =>
                {
                    b.HasOne("VPureLux.Customers.CustomerGroup", null)
                        .WithMany()
            ...
            modelBuilder.Entity("VPureLux.Inventory.InventoryBalance", b =>
                {
                    b.HasOne("VPureLux.Inventory.StockItem", null)
                        .WithMany()
            ...
            modelBuilder.Entity("VPureLux.Inventory.InventoryLotSupplier", b =>
                {
                    b.HasOne("VPureLux.Inventory.InventoryLot", null)
                        .WithMany()
                        .HasForeignKey("InventoryLotId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("VPureLux.Suppliers.Supplier", null)
                        .WithMany()
            ...
            modelBuilder.Entity("VPureLux.Inventory.InventoryTransaction", b =>
                {
                    b.HasOne("VPureLux.Bom.BomVersion", null)
                        .WithMany()
                        .HasForeignKey("BomVersionId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.OwnsMany("VPureLux.Inventory.InventoryTransactionLine", "Lines", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("uniqueidentifier");

                            b1.Property<byte>("Direction")
                                .HasColumnType("tinyint");
                            ...
                            b1.ToTable("AppInventoryTransactionLines", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("InventoryTransactionId");

                            b1.HasOne("VPureLux.Inventory.StockItem", null)
                                .WithMany()
                                .HasForeignKey("StockItemId")
                                .OnDelete(DeleteBehavior.Restrict)
                                .IsRequired();

                            b1.OwnsMany("VPureLux.Inventory.InventoryLotAllocation", "Allocations", b2 =>
                                {
                                    b2.Property<Guid>("Id")
                                        .ValueGeneratedOnAdd()
                                        .HasColumnType("uniqueidentifier");
                                    ...
                                    b2.Property<Guid>("InventoryTransactionLineId")
                                        .HasColumnType("uniqueidentifier");
                                    ...
                                    b2.HasIndex("InventoryTransactionLineId");

                                    b2.ToTable("AppInventoryLotAllocations", (string)null);
            ...
            modelBuilder.Entity("VPureLux.OperatingCosts.OperatingCostEntry", b =>
                {
                    b.HasOne("VPureLux.OperatingCosts.OperatingCostCategory", null)
                        .WithMany()
            ...
            modelBuilder.Entity("VPureLux.Pricing.ComponentSuggestedSellingPriceVersion", b =>
                {
                    ...
                    b.OwnsOne("VPureLux.Pricing.EffectivePeriod", "EffectivePeriod", b1 =>
                        {
                            b1.Property<Guid>("ComponentSuggestedSellingPriceVersionId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("ComponentSuggestedSellingPriceVersionId");

                            b1.ToTable("AppComponentSuggestedSellingPriceVersions");

                            b1.WithOwner()
                                .HasForeignKey("ComponentSuggestedSellingPriceVersionId");
                        });

                    b.OwnsOne("VPureLux.Pricing.Money", "Price", b1 =>
                        {
                            b1.Property<Guid>("ComponentSuggestedSellingPriceVersionId")
                                .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VPureLux.Pricing.ProductSuggestedPriceVersion", b =>
                {
                    ...
                    b.OwnsOne("VPureLux.Pricing.EffectivePeriod", "EffectivePeriod", b1 =>
                        {
                            b1.Property<Guid>("ProductSuggestedPriceVersionId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("ProductSuggestedPriceVersionId");

                            b1.ToTable("AppProductSuggestedPriceVersions");

                            b1.WithOwner()
                                .HasForeignKey("ProductSuggestedPriceVersionId");
                        });
            ...
            modelBuilder.Entity("VPureLux.Sales.SalesOrder", b =>
                {
                    b.HasOne("VPureLux.Customers.CustomerGroup", null)
                        .WithMany()
                        .HasForeignKey("CustomerGroupIdSnapshot")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.OwnsMany("VPureLux.Sales.SalesOrderLine", "Lines", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.Property<int?>("BomVersionNoSnapshot")
                                .HasColumnType("int");
                            ...
                            b1.Property<decimal>("CostPriceSnapshot")
                                .HasPrecision(18, 2)
                                .HasColumnType("decimal(18,2)");
                            ...
                            b1.Property<decimal>("ProfitAmount")
                                .HasPrecision(18, 2)
                                .HasColumnType("decimal(18,2)");
                            ...
                            b1.HasIndex("LineType", "CatalogItemId")
                                .HasDatabaseName("IX_SalesOrderLines_LineType_CatalogItemId");
                            ...
                            b1.HasOne("VPureLux.Pricing.ProductSuggestedPriceVersion", null)
                                .WithMany()
                                .HasForeignKey("SuggestedPriceVersionId")
                                .OnDelete(DeleteBehavior.Restrict);

                            b1.OwnsMany("VPureLux.Sales.SalesOrderBomSnapshotItem", "BomSnapshotItems", b2 =>
                                {
                                    b2.Property<Guid>("Id")
                                        .ValueGeneratedOnAdd()
                                        .HasColumnType("uniqueidentifier");

                                    b2.Property<string>("ComponentCode")
                                        .IsRequired()
                                        .HasMaxLength(50)
                                        .HasColumnType("nvarchar(50)");

                                    b2.Property<Guid>("ComponentId")
                                        .HasColumnType("uniqueidentifier");

                                    b2.Property<string>("ComponentName")
                                        .IsRequired()
                                        .HasMaxLength(200)
                                        .HasColumnType("nvarchar(200)");

                                    b2.Property<decimal>("QuantityPerProduct")
                                        .HasPrecision(18, 4)
                                        .HasColumnType("decimal(18,4)");
                                    ...
                                    b2.Property<decimal>("TotalRequiredQuantity")
                                        .HasPrecision(18, 4)
                                        .HasColumnType("decimal(18,4)");
                                    ...
                                    b2.HasIndex("SalesOrderLineId");

                                    b2.ToTable("AppSalesOrderBomSnapshotItems", (string)null);

                                    b2.HasOne("VPureLux.Catalog.Component", null)
                                        .WithMany()
                                        .HasForeignKey("ComponentId")
                                        .OnDelete(DeleteBehavior.Restrict)
                                        .IsRequired();
                            ...
                            b1.Navigation("BomSnapshotItems");
                        });
                    ...
                    b.OwnsMany("VPureLux.Service.ServiceOrderLine", "Lines", b1 =>
                        {
                            ...
                            b1.Property<decimal?>("ActualCostAmount")
                                .HasPrecision(18, 2)
                                .HasColumnType("decimal(18,2)");
                            ...
                            b1.Property<Guid?>("InventoryTransactionLineId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.Property<decimal?>("StandardCostSnapshot")
                                .HasPrecision(18, 2)
                                .HasColumnType("decimal(18,2)");
