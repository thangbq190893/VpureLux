...
**Status:** Batch 15 **complete** (15.1 plan through 15.5 validation and PR summary). All scoped list/index pages polished with Batch 14 helpers. Deferred items documented in plan and PR summary.
