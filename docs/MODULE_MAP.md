...
## Service (S-001/S-002/S-003/S-004/S-005)
...
- **S-006 evidence:** `S006_SERVICE_UAT_20260907.md`, `evidence/s006/verification-evidence.json`. User-authorized VPL backup/clone/empty chain and four pending migrations applied, no business DML/backfill; final41/41 legacy fingerprints unchanged. Real SQL/Redis9races, operator care/money/HTTP/UI and394tests pass; full combined Web not claimed. Clean b0bf197 full publish verified locally, production never accessed/deployed, no push. C01 requires explicit acceptance of projection-only planned10/actual12 coverage because accepted S003 disallows completing above planned charge.
